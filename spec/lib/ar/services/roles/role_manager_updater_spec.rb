...
describe Ar::Services::Roles::RoleManagerUpdater, type: :service, fast: true do
  ...
  let(:setup_updaters) do
    allow(Ar::Services::Roles::Update::RoleUpdater).to receive(:new).and_return(role_updater)
  end
